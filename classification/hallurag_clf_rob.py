...
ROB_PARAMS = {
    ...
    "prompt_template_name": ["template_langchain_hub", "template_1", "template_2"]
}
...
if __name__ == "__main__":
    ...
    for p in ROB_PARAMS:
        results[p] = {}
        for v in ROB_PARAMS[p]:
            results[p][v] = run(MODEL_NAME_START, INTERNAL_STATE_NAME, p, v, shuffle_y=False)

    with open(RESULTS_FILE, "w") as file:
        json.dump(results, file, default=str)