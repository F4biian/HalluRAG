...
if __name__ == "__main__":
    ...
    for response_id, response_row in model_responses.iterrows():
        ...
        if response_row["source_id"] not in source_ids_in_common: # When long prompt internal states: replace "not in" with "in"
            continue
        ...
        try:
            for sent_i in range(len(cum_sentences)):
                if response_sentences[sent_i] not in all_sentences["sentence"]:
                    continue
